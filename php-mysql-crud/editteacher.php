...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE teachers set firstname = '$firstname',lastname = '$lastname', description = '$description' WHERE id=$id";
...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <form action="editteacher.php?id=<?php echo $_GET['id']; ?>" method="POST">
